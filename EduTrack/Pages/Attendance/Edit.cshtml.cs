    ...
    public class EditModel : PageModel
    {
        ...
        public IActionResult OnGet(int id)
        {
            ...
            AttendanceViewModel = new AttendanceViewModel
            {
                ...
                ClassSubject_Id = attendance.ClassSubject_Id ?? 0,
        ...
        public IActionResult OnPost()
        {
            ...
            try
            {
                ...
                {
                    Attendance_Id = AttendanceViewModel.Attendance_Id,
                    ...
                    IsActive = AttendanceViewModel.IsActive,
                    IsDeleted = AttendanceViewModel.IsDeleted,
                    Created_By = AttendanceViewModel.Created_By,
                    Created_Date = AttendanceViewModel.Created_Date,

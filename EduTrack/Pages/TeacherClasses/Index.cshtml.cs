...
namespace EduTrack.Pages.TeacherClasses
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(ITeacherClassService teacherClassService, ITeacherService teacherService, IClassService classService, ISubjectService subjectService)
        {
        ...
        public void OnGet()
        {
            ...
            TeacherClasses = teacherClasses.Select(tc => new TeacherClassViewModel
            {
                ...
                Subject_Id = subjects.FirstOrDefault(s => s.Subject_Name == tc.Subject)?.Subject_Id ?? 0,
                ...
                ClassName = classes.FirstOrDefault(c => c.Class_Id == tc.Class_Id)?.ClassName ?? "N/A",
                Section = classes.FirstOrDefault(c => c.Class_Id == tc.Class_Id)?.Section ?? "N/A",
